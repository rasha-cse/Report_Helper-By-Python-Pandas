...
input_r_dataframe = pd.read_excel(input_r_path, sheetname='Sheet1', na_values=['NA'], converters={'SIS_TRACKING_NUM': lambda x: str(x)})
...
exists_both_sides = exists_both_sides_dataframe[exists_both][['SIS_ID', 'FIRST_NAME_r', 'LAST_NAME_r', 'SIS_TRACKING_NUM_r', 'Concatenated_r', 'First_Name_SIS_Online', 'Last_Name_SIS_Online', 'Tracking Number_SIS_Online', 'Concatenated_SIS_Online']]
...
exists_both_sides['Matched/Mismatched?'] = np.where(exists_both_sides['Concatenated_r'] == exists_both_sides['Concatenated_SIS_Online'], 'Matched',
                                                    np.where(exists_both_sides['SIS_TRACKING_NUM_r'] == exists_both_sides['Tracking Number_SIS_Online'], 'Name Mismatched', 'Tracking # Mismatched'))
...
exists_both_sides = exists_both_sides[['SIS_ID', 'FIRST_NAME_r', 'LAST_NAME_r', 'SIS_TRACKING_NUM_r', 'Concatenated_r', 'Matched/Mismatched?', 'First_Name_SIS_Online', 'Last_Name_SIS_Online', 'Tracking Number_SIS_Online', 'Concatenated_SIS_Online']]
